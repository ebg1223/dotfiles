...
See the shared [agent and model selection guide](agent-selection.md) for reusable routing principles. Keep omegacode-specific CLI/provider mechanics in this skill and generic model-selection policy in the shared guide.
...
Use the shared [agent and model selection guide](agent-selection.md) for deciding what capability tier a step needs. This section only documents how omegacode expresses that choice.
